...
<div v-if="isLoading" class="fixed inset-0 bg-purple-900 flex items-center justify-center z-50">
  <div class="flex flex-col items-center text-white">
    <img src="/dist/assets/logo.png" class="w-20 h-20 animate-bounce mb-4" alt="Loading Logo" />
...
<div class="w-full px-4 py-2 flex justify-end">
  ...
  <div>
    <div class="mx-auto flex justify-center">
      <img src="/dist/assets/logo.png" alt="Logo" class="w-32 h-32" />
    </div>
